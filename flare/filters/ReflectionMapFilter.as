package flare.materials.filters 
{
	 ...
	 * @author Ariel Nehmad
	 */
	public class ReflectionMapFilter extends FLSLFilter 
	{
		[Embed(source = "../shaders/reflectionMap.flsl.compiled", mimeType = "application/octet-stream")]
		private static var flsl:Class;
		private static var data:ByteArray = new flsl;
		
		public function ReflectionMapFilter( texture:Texture3D = null, level:Number = 1, blendMode:String = BlendMode.MULTIPLY ) 
		{
