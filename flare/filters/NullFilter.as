package flare.materials.filters 
{
	 ...
	 * @author Ariel Nehmad
	 */
	public class NullFilter extends FLSLFilter 
	{
		[Embed(source = "../shaders/nullFilter.flsl.compiled", mimeType = "application/octet-stream")]
		private static var flsl:Class;
		private static var data:ByteArray = new flsl;
		
		public function NullFilter( color:int = 0xffffff, size:Number = 10, blendMode:String = BlendMode.MULTIPLY ) 
		{
